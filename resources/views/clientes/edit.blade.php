...
@csrf
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="nombre" id="inputEmail4" placeholder="Nombre" value="{{$cliente->nombre}}">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Email</label>
      <input type="text" class="form-control" name="email" id="inputPassword4" placeholder="Email" value="{{$cliente->email}}">
    </div>
  </div>

  <div class="form-group">
    <label for="inputAddress">Direccion</label>
    <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="direccion" value="{{$cliente->direccion}}">
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      @change="loadStates" name="cbo_pais"  class="form-control">
        @foreach ($paises->get() as $index => $value)        
          <option value="{{$index}}" @if($cliente->pais_id===$index) selected @endif  
            >{{$value}}</option>  
        @endforeach
    ...
    <div class="form-group col-md-4">
      <label for="inputCity">Estado</label>
       <input type="text" id="estado_id" value="{{$cliente->estado_id}}">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" id="ciudad_id" value="{{$cliente->ciudad_id}}">
   ...
   <div class="form-row">
      <div class="col-md-4">
          <label for="fechaNacimiento">Fecha Nacimiento</label>
            ...
            placeholder="MM/DD/YYYY" type="text" value="{{$cliente->f_nacimiento->format('m/d/Y')}}"/>
      </div>
